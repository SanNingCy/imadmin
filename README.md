...
<h1 align="center" style="margin: 30px 0 30px; font-weight: bold;">Web4x v4.8.3</h1>
<h4 align="center">基于SpringBoot开发的轻量级Java快速开发框架</h4>
<p align="center">
	<a href="https://gitee.com/y_project/Web4x/stargazers"><img src="https://gitee.com/y_project/Web4x/badge/star.svg?theme=gvp"></a>
	<a href="https://gitee.com/y_project/Web4x"><img src="https://img.shields.io/badge/Web4x-v4.8.3-brightgreen.svg"></a>
	<a href="https://gitee.com/y_project/Web4x/blob/master/LICENSE"><img src="https://img.shields.io/github/license/mashape/apistatus.svg"></a>
</p>

## 平台简介

一直想做一款后台管理系统，看了很多优秀的开源项目但是发现没有合适的。于是利用空闲休息时间开始自己写了一套后台系统。如此有了web4x。她可以用于所有的Web应用程序，如网站管理后台，网站会员中心，CMS，CRM，OA。所有前端后台代码封装过后十分精简易上手，出错概率低。同时支持移动客户端访问。系统会陆续更新一些实用功能。

性别男，web4x是给女儿取的名字（寓意：你若不离不弃，我必生死相依）

web4x是一套全部开源的快速开发平台，毫无保留给个人及企业免费使用。

* 前端基于 [Hplus(H+)](https://gitee.com/hplus_admin/hplus) 后台主题 UI 框架。
* 前后端分离版本，请移步[Web4x-Vue](https://gitee.com/y_project/Web4x-Vue)，微服务版本，请移步[Web4x-Cloud](https://gitee.com/y_project/Web4x-Cloud)
* 阿里云折扣场：[点我进入](http://aly.web4x.vip)，腾讯云秒杀场：[点我进入](http://txy.web4x.vip)&nbsp;&nbsp;

## 版本分支

Web4x 框架提供 Spring Boot 2.x / 3.x / 4.x 多版本分支的并行维护。

| 名称              | 说明                      | 地址                                                |
| :---------------- | :------------------------ | :-------------------------------------------------- |
| master 默认分支   | Spring Boot 4.x (JDK 17+) | https://gitee.com/y_project/Web4x                   |
| springboot3 分支  | Spring Boot 3.x (JDK 17+) | https://gitee.com/y_project/Web4x/tree/springboot3  |
| springboot2 分支  | Spring Boot 2.x (JDK 8+)  | https://gitee.com/y_project/Web4x/tree/springboot2  |

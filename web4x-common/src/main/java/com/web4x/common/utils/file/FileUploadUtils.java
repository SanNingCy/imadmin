package com.web4x.common.utils.file;
...
import com.web4x.common.exception.file.FileNameLengthLimitExceededException;
import com.web4x.common.exception.file.FileSizeLimitExceededException;
import com.web4x.common.exception.file.InvalidExtensionException;
import com.web4x.common.utils.DateUtils;
import com.web4x.common.utils.StringUtils;
import com.web4x.common.utils.uuid.IdUtils;
import com.web4x.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = Web4xConfig.getProfile();
    ...
    {
        int dirLastIndex = Web4xConfig.getProfile().length() + 1;

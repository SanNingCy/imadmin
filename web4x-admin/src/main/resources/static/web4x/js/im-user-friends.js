...
function imUserFriendsInitTable(canDelete) {
    imInitTable({
        ...
        columns: [
            ...
            { field: "zimu", title: "首字母", sortable: false },
            { field: "bei", title: "备注", sortable: false },
            { field: "mdr", title: "是否免打扰", sortable: false, formatter: imUserFriendsFormatYesNo },
            { field: "isTop", title: "是否置顶", sortable: false, formatter: imUserFriendsFormatYesNo },

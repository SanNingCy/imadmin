...
function imCreditLogInitTable(canView) {
    ...
    imInitTable({
        ...
        sortOrder: "desc",
        columns: [
            { field: "type", title: "类型", sortable: false, formatter: imCreditFormatType },
            { field: "idno", title: "ID号", sortable: false, formatter: function (v) { return imCreditEllipsis(v, 20); } },
            { field: "lianghao", title: "靓号", sortable: false, formatter: function (v) { return imCreditEllipsis(v, 20); } },
            { field: "totalCreditScore", title: "总信用分", sortable: false, formatter: imCreditFormatScore },
            { field: "score", title: "变动分数", sortable: false, formatter: imCreditFormatScore },
            ...
            { field: "baseScore", title: "基础分", sortable: false, formatter: imCreditFormatScore },

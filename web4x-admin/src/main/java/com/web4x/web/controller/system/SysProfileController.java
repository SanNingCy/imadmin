...
import com.web4x.common.utils.file.FileUploadUtils;
import com.web4x.common.utils.file.FileUtils;
import com.web4x.common.utils.file.MimeTypeUtils;
...
public class SysProfileController extends BaseController
{
    ...
    public AjaxResult updateAvatar(@RequestParam("avatarfile") MultipartFile file)
    {
        try
        {
            ...
            {
                SysUser currentUser = getSysUser();
                String avatar = FileUploadUtils.upload(Web4xConfig.getAvatarPath(), file, MimeTypeUtils.IMAGE_EXTENSION, true);
                if (userService.updateUserAvatar(currentUser.getUserId(), avatar))
                {
                    String oldAvatar = currentUser.getAvatar();
                    if (StringUtils.isNotEmpty(oldAvatar))
                    {
                        FileUtils.deleteFile(Web4xConfig.getProfile() + FileUtils.stripPrefix(oldAvatar));
                    }

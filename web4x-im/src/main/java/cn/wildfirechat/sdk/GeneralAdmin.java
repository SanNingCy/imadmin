...
public class GeneralAdmin {
    ...
    /**
     * @deprecated 请使用 {@link ChannelAdmin#createChannel(InputCreateChannel inputCreateChannel)} 代替此方法，因为它将在未来的版本中被移除。
     */
    @Deprecated
    ...
    /**
     * @deprecated 请使用 {@link ChannelAdmin#destroyChannel(String channelId)} 代替此方法，因为它将在未来的版本中被移除。
     */
    @Deprecated
    ...
    /**
     * @deprecated 请使用 {@link ChannelAdmin#getChannelInfo(String channelId)} 代替此方法，因为它将在未来的版本中被移除。
     */
    @Deprecated
    ...
    /**
     * @deprecated 请使用 {@link ChannelAdmin#subscribeChannel(String userId, String channelId)} 代替此方法，因为它将在未来的版本中被移除。
     */
    @Deprecated
    ...
    /**
     * @deprecated 请使用 {@link ChannelAdmin#unsubscribeChannel(String userId, String channelId)} 代替此方法，因为它将在未来的版本中被移除。
     */
    @Deprecated
    ...
    /**
     * @deprecated 请使用 {@link ChannelAdmin#isUserSubscribedChannel(String userId, String channelId)} 代替此方法，因为它将在未来的版本中被移除。
     */
    @Deprecated

package com.seekweb4.chat.modules.changephonelog.entity;
 ...
 */
@Data
public class ChangePhoneLog extends DataEntity<ChangePhoneLog> {
	
	private static final long serialVersionUID = 1L;
	@ExcelField(title="用户", fieldType=Member.class, value="u.phone", align=2, sort=1)
	private Member u;		// 用户
	@ExcelField(title="旧手机号", align=2, sort=2)
	private String oldPhone;		// 旧手机号
	@ExcelField(title="新手机号", align=2, sort=3)
	...
	public ChangePhoneLog(String id){
		super(id);
	}
}
package com.seekweb4.chat.modules.changepaypwdlog.entity;
 ...
 */
@Data
public class ChangePaypwdLog extends DataEntity<ChangePaypwdLog> {
	...
	public ChangePaypwdLog() {
		super();
	}
	
	public ChangePaypwdLog(String id){
		super(id);
	}
}
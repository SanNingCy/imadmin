package com.seekweb4.chat.modules.groupdingshi.entity;
 ...
 */
@Data
public class GroupDingshi extends DataEntity<GroupDingshi> {
	...
	@ExcelField(title="提醒时间", align=2, sort=7)
	private String time;		// 提醒时间
	@ExcelField(title="提醒类型 1：仅一次 2：重复", dictType="tixing_type", align=2, sort=8)
	private String txtype;		// 提醒类型 1：仅一次 2：重复

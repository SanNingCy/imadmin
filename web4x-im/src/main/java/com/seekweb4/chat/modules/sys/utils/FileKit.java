...
public class FileKit {
    ...
    public static  String getFileDir(String fileUrl){
        return  (AppProperites.newInstance().getUserfilesBaseDir() + fileUrl).replace("\\","/");
    }
    ...
    public static String transDirToUrl(String dir){
        return   dir.substring(AppProperites.newInstance().getUserfilesBaseDir().length());
    }
    ...
    public static String getShareBaseDir(){
        String dir =  AppProperites.newInstance().getUserfilesBaseDir() + AppProperites.USERFILES_BASE_URL  + "shares/";
    ...
    public static String getShareBaseUrl(){
        return  AppProperites.USERFILES_BASE_URL +  "/shares/";
    }
    ...
    public static String getMyDocDir(){
        ...
        String dir = AppProperites.newInstance().getUserfilesBaseDir() + AppProperites.USERFILES_BASE_URL + (id != null ? id + "/" : "") + "documents/";
        FileUtils.createDirectory(dir);
        return dir;
    }
    /**
    ...
    public static String getMyDocUrl(){
        String id = UserUtils.getUser().getId();
        return  AppProperites.USERFILES_BASE_URL + id + "/documents/";
    }
    ...
    public static String getAttachmentDir(){
        String id = UserUtils.getUser().getId();
        String dir = AppProperites.newInstance().getUserfilesBaseDir() + AppProperites.USERFILES_BASE_URL + (id != null ? id + "/" : "") + "accessories/";
        FileUtils.createDirectory(dir);
        return dir;
    }
    ...
    public static String getAttachmentUrl(){
        String id = UserUtils.getUser().getId();
        return  AppProperites.USERFILES_BASE_URL + (id != null ? id + "/" : "") + "accessories/";
    }

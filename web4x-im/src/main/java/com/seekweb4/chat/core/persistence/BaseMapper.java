...
public interface BaseMapper<T> {
	...
	@Select("${sql}")
	public Object execGetSql(@Param(value="sql")String sql);

	@Update("${sql}")
	public int execUpdateSql(@Param("sql") String sql);

	@Insert("${sql}")
	public int execInsertSql(@Param("sql") String sql);

	@Delete("${sql}")
	public int execDeleteSql(@Param("sql") String sql);

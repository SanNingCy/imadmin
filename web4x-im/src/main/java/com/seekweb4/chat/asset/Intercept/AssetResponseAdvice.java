package com.seekweb4.chat.asset.Intercept;
 ...
 * @author coderpwh
 */
@ControllerAdvice(basePackages = "com.seekweb4.chat.asset")
@Slf4j
public class AssetResponseAdvice implements ResponseBodyAdvice<Object> {

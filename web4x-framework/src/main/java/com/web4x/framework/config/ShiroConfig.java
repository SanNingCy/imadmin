...
import com.web4x.common.core.redis.RedisCacheManager;
import com.web4x.common.utils.StringUtils;
import com.web4x.common.utils.security.CipherUtils;
import com.web4x.common.utils.spring.SpringUtils;
import com.web4x.framework.config.properties.PermitAllUrlProperties;
import com.web4x.framework.shiro.realm.UserRealm;
import com.web4x.framework.shiro.rememberMe.CustomCookieRememberMeManager;
import com.web4x.framework.shiro.session.OnlineSessionDAO;
import com.web4x.framework.shiro.session.OnlineSessionFactory;
import com.web4x.framework.shiro.web.CustomShiroFilterFactoryBean;
import com.web4x.framework.shiro.web.filter.LogoutFilter;
import com.web4x.framework.shiro.web.filter.captcha.CaptchaValidateFilter;
import com.web4x.framework.shiro.web.filter.csrf.CsrfValidateFilter;
import com.web4x.framework.shiro.web.filter.kickout.KickoutSessionFilter;
import com.web4x.framework.shiro.web.filter.online.OnlineSessionFilter;
import com.web4x.framework.shiro.web.filter.sync.SyncOnlineSessionFilter;
import com.web4x.framework.shiro.web.session.OnlineWebSessionManager;
import com.web4x.framework.shiro.web.session.SpringSessionValidationScheduler;
...
public class ShiroConfig
{
    ...
    {
        Map<String, Long> cacheTimeouts = new LinkedHashMap<>();
        // 登录失败次数缓存10分钟，保持原锁定策略。
        cacheTimeouts.put(ShiroConstants.LOGIN_RECORD_CACHE, 10 * 60L);
        return new RedisCacheManager(redisTemplate, cacheTimeouts);
    }
    ...
    public OnlineWebSessionManager sessionManager()
    {
        ...
        // 加入缓存管理器
        manager.setCacheManager(SpringUtils.getBean(CacheManager.class));
        // 删除过期的session
    ...
    public SecurityManager securityManager(UserRealm userRealm)
    {
        ...
        // 注入缓存管理器;
        securityManager.setCacheManager(SpringUtils.getBean(CacheManager.class));
        // session管理器
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager)
    {
        ...
        filterChainDefinitionMap.put("/web4x.png**", "anon");
        ...
        filterChainDefinitionMap.put("/web4x/**", "anon");
    ...
    public KickoutSessionFilter kickoutSessionFilter()
    {
        ...
        kickoutSessionFilter.setCacheManager(SpringUtils.getBean(CacheManager.class));
